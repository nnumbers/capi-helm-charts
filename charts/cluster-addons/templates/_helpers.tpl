...
capi.nnumbers.com.br/cluster: {{ index . 0 | include "cluster-addons.clusterName" }}
capi.nnumbers.com.br/component: {{ index . 1 }}
{{- end -}}
...
capi.nnumbers.com.br/managed-by: {{ (index . 0).Release.Service }}
